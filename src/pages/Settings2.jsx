      ...
      <div className="settings-drawer-content">
        ...
        <section className="settings-section premium-section">
          ...
          <label className="radio-label">
            <input type="radio" value="light" checked={theme === 'light'} onChange={handleThemeChange} />
            {t('light')}
          </label>
          <label className="radio-label">
            <input type="radio" value="dark" checked={theme === 'dark'} onChange={handleThemeChange} />
            {t('dark')}
          </label>
        </section>
