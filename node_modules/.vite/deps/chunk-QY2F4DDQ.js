...
var Slide = React8.forwardRef(function Slide2(props, ref) {
  const theme = useTheme();
  const defaultEasing = {
  ...
  const childrenRef = React8.useRef(null);
  ...
  const updatePosition = React8.useCallback(() => {
...
var Paper = React9.forwardRef(function Paper2(inProps, ref) {
  ...
  return (0, import_jsx_runtime6.jsx)(PaperRoot, {
    as: component,
    ownerState,
    className: clsx_default(classes.root, className),
    ref,
...
var Drawer = React10.forwardRef(function Drawer2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiDrawer"
  });
  ...
  const drawer = (0, import_jsx_runtime7.jsx)(PaperSlot, {
    ...paperSlotProps,
    children
  });
  if (variant === "permanent") {
    return (0, import_jsx_runtime7.jsx)(DockedSlot, {
      ...dockedSlotProps,
      children: drawer
    });
  }
  const slidingDrawer = (0, import_jsx_runtime7.jsx)(TransitionSlot, {
    ...transitionSlotProps,
    children: drawer
  });
...
true ? Drawer.propTypes = {
   ...
   * @default 'left'
   */
  anchor: import_prop_types9.default.oneOf(["bottom", "left", "right", "top"]),
  /**
   * @ignore
   */
   ...
   * @default {}
   */
  ModalProps: import_prop_types9.default.object,
  /**
   * Callback fired when the component requests to be closed.
   * The `reason` parameter can optionally be used to control the response to `onClose`.
   *
   ...
   */
  SlideProps: import_prop_types9.default.object,
  /**
   * The props used for each slot inside.
   * @default {}
   */
  slotProps: import_prop_types9.default.shape({
    ...
    docked: import_prop_types9.default.oneOfType([import_prop_types9.default.func, import_prop_types9.default.object]),
  ...
  slots: import_prop_types9.default.shape({
    ...
    docked: import_prop_types9.default.elementType,
   ...
   * @default 'temporary'
   */
  variant: import_prop_types9.default.oneOf(["permanent", "persistent", "temporary"])
} : void 0;
...
//# sourceMappingURL=chunk-QY2F4DDQ.js.map
